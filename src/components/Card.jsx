        ...
        <>
            <div className="w-4/5 max-w-sm p-6 m-3 text-center text-white duration-300 rounded-md shadow-lg shadow-grey-dark border-gray hover:shadow-gray xl:w-full lg:max-w-none ">
                <div className="px-6 pt-4 pb-2">
                    <span className="inline-block px-3 py-1 mb-2 mr-2 text-sm font-semibold bg-gray-200 rounded-full text-gray">{date}</span>
                </div>
                ...
                <a className="underline text-blue" target="_blank" href="https://fuchsia-madeline-16.tiiny.site">{recommendation}</a>
            </div>
        </>
