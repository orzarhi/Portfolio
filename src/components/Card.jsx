...
export const Card = ({ title, section, place, date, recommendation }) => {
    return (
        <main className=" w-4/5 max-w-sm p-6 m-3 text-center text-white duration-300 border rounded-md shadow-lg shadow-white/40  hover:shadow-white/80 xl:w-full lg:max-w-none">
