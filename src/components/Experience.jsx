...
export const Experience = () => {
    return (
        < >
            <div className="flex justify-center text-white font-electrolize xl:mt-72 lg:mt-28 md:mt-80 sm:mt-40">
                <span className="text-3xl underline decoration-blue-dark/80 ">
                    Experience
                </span>
            </div>
            <div className="grid grid-cols-3 gap-2 p-4 mt-4 ml-3 justify-items-center xl:grid-cols-3 lg:grid-cols-2 md:grid-cols-1 md:justify-items-center md:ml-0 sm:w-full md:mt-2 sm:-mt-5">
