...
export const Technologies = () => {
    ...
    return (
        <main className="w-full text-white bg-gradient-to-br from-teal/30 to-blue/5 via-purple/5 font-electrolize">
            <motion.div
                ref={ref}
                variants={boxVariant}
                initial="hidden"
            ...
            >
                <div className="flex justify-center">
                    <span className="mt-24 text-3xl underline selection decoration-blue-dark/80">My favorite technologies</span>
                </div>
